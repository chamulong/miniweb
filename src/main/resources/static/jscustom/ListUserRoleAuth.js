/************
 * 有关账号角色权限管理的相关脚本控制都在这个文件中
 ***********/
require(
    ['/jscustom/GlobleConfig.js'],
    function(){
        requirejs(
            ['jquery','bootstrap','bootstraptable','bootstraptableCN','ztree','layer','jqueryform'],
            function($){
                //******自定义功能块******

                //由于layer不是遵照AMD规范，所以我们在引入layer插件的js文件中都需要利用layer的config函数进行初始化全局设置
                layer.config({
